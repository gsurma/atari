...
class Atari:
    ...
    def _args(self):
        ...
        parser.add_argument("-tsl", "--total_step_limit", help="Choose how many total steps (frames visible by agent) should be performed. Default is '10000000'.", default=10000000, type=int)
